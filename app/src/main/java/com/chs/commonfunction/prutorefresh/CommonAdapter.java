...
import com.chs.commonfunction.utils.DensityUtil;
...
public abstract class CommonAdapter<T> extends RecyclerView.Adapter<ViewHolder> {
    ...
    public CommonAdapter(Context context, int layoutId, List<T> datas, RecyclerView recyclerView)
    {
        mContext = context;
