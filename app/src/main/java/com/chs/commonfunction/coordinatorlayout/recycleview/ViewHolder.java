package com.chs.commonfunction.coordinatorlayout.recycleview;
...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public ViewHolder setTextDrawable(int viewId, int resId) {
        TextView tv = getView(viewId);
    ...
    public ViewHolder setImageWithUrl(int viewId, String url) {
        ImageView view = getView(viewId);
//        BXTImageLoader.setImageView(url,view);
        return this;
    }
