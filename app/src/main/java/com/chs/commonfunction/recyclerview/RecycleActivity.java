...
import com.chs.commonfunction.bean.ItemModel;
...
public class RecycleActivity extends AppCompatActivity {
    ...
    private EndlessRecyclerOnScrollListener mOnScrollListener = new EndlessRecyclerOnScrollListener() {
        ...
        public void onLoadNextPage(View view) {
            ...
            if (mCurrentCounter < TOTAL_COUNTER) {
                // loading more
                RecyclerViewStateUtils.setFooterViewState(RecycleActivity.this, mRecyclerView, REQUEST_COUNT, LoadingFooter.State.Loading, null);
                requestData();
            } else {
                //the end
                RecyclerViewStateUtils.setFooterViewState(RecycleActivity.this, mRecyclerView, REQUEST_COUNT, LoadingFooter.State.TheEnd, null);
            }
        }
    };
    ...
    private static class PreviewHandler extends Handler {
        ...
        private WeakReference<RecycleActivity> ref;

        PreviewHandler(RecycleActivity activity) {
            ref = new WeakReference<>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            final RecycleActivity activity = ref.get();
    ...
    private void requestData() {
        ...
        new Thread() {
            ...
            public void run() {
                ...
                //模拟一下网络请求失败的情况
                if (NetUtils.isNetworkConnected(RecycleActivity.this)) {
                    if (mCurrentPage == 1) {
            ...
            public ViewHolder(View itemView) {
                ...
                textView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(RecycleActivity.this, item.title, Toast.LENGTH_SHORT).show();
                    }
                });
            }
        }
